package com.kibong.refactoring_study.long_function._07_replace_temp_with_query;
...
public class StudyDashboard {
    ...
    private void print() throws IOException, InterruptedException {
        ...
        for (int index = 1 ; index <= totalNumberOfEvents ; index++) {
            ...
            service.execute(new Runnable() {
                ...
                public void run() {
                    try {
                        GHIssue issue = getGhRepository().getIssue(eventId);
        ...
        try (FileWriter fileWriter = new FileWriter("participants.md");
            ...
            participants.forEach(p -> {
                writer.print(getMarkDownForParticipant(p, totalNumberOfEvents, getRate(p, totalNumberOfEvents)));
            });
        }
    }
    ...
    private String getMarkDownForParticipant(Participant p, int totalNumberOfEvents, double rate) {
