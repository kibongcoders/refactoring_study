package com.kibong.refactoring_study.long_function._11_decompose_conditional;
...
public class StudyDashboard {
    ...
    private static Participant createParticipant(String username, List<Participant> participants) {
        Participant participant;
