package com.kibong.refactoring_study.long_parameter_list._16_combine_functinos_into_class;
...
public class StudyPrinter {
    ...
    private String getMarkdownForParticipant(Participant participant) {
        return String.format("| %s %s | %.2f%% |\n", participant.username(), checkMark(participant.homework()), getRate(participant.homework()));
    }
